...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2020 at 03:21 PM
...
(39, 'test', 'test', 'test', '2020-06-10', '213', 26, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(40, 'qsdfqsdf', 'qsdf', 'qsqd', '2020-05-31', '20833787', 20, 'tunis', 'tunis', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(73, 'universite de tunis', 'universite de tunis.png', 29, 1),
(74, 'universite paris saclay', 'universite paris saclay.png', 29, 1),
(75, 'ecole normale paris saclay', 'ecole normale paris saclay.png', 29, 1),
(76, 'ensit', 'ensit.png', 29, 1);
...
(25, 'yes', 'Hornella DUAMBE', 'Un des avantages les plus importants d\'Ã©tudier Ã  l\'UFTAM est quâ€™il s\'agit nÃ©cessairement de l\'ouverture Ã  l\'Ã©chelle internationale, de quoi dÃ©coulent plusieurs avantages. La garantie d\'un diplÃ´me qui pourrait Ãªtre reconnu Ã  l\'international est avantageux pour tous, car actuellement, la qualitÃ© du diplÃ´me est aussi jugÃ©e en raison de sa provenance. L\'UFTAM travaille sur une mÃ©thodologie qui permet Ã  tous les Ã©tudiants d\'avoir accÃ¨s aux Ã©lÃ©ments nÃ©cessaires et indispensables Ã  leur formation.Â Un cours est d\'autant plus apprÃ©ciÃ© lorsque son domaine thÃ©orie et son domaine pratique se joignent lors de l\'apprentissage.', 'sixth.jpeg', 'Etudiante en premi&egrave;re ann&eacute;e master Gestion de l&rsquo;environnement et m&eacute;tiers\r\nde l&rsquo;eau'),
(26, 'yes', 'Mariem Doggui', 'Jâ€™ai beaucoup aimÃ© lâ€™approche pÃ©dagogique que proposait cette formation et le fait dâ€™avoir une matiÃ¨re dispensÃ©e par une partie francophone et tunisienne permettant ainsi dâ€™avoir une interaction intÃ©ressante. Toutes les matiÃ¨res sont en fait en complÃ©mentaritÃ© les unes avec les autres sans pour autant tomber dans la rÃ©pÃ©titivitÃ©.', 'mariem.png', '&eacute;tudiante en premi&egrave;re ann&eacute;e master Gestion de l&rsquo;environnement et m&eacute;tiers de l&rsquo;eau&nbsp'),
(27, 'yes', 'Atef Hsini', 'Le grand avantage de l\'UFTAM c\'est le diplÃ´me franÃ§ais d\'Aix-Marseille reconnu dans le monde que je vais obtenir Ã  la fin du cursus et aussi le diplÃ´me tunisien, et le large Ã©ventail des parties-prenantes des deux rives de la MÃ©diterranÃ©e qui facilitent la mobilitÃ© pendant et aprÃ¨s la formation. La \"formation miroir\" de celle qui existe Ã  Marseille, avec les mÃªmes enseignants franÃ§ais, va me permettre par la suite d\'intÃ©grer les structures de recherche en France au cas oÃ¹ je voudrais continuer en thÃ¨se de doctorat.', 'atef.png', '&eacute;tudiant en premi&egrave;re ann&eacute;e master Gestion de l&rsquo;environnement et m&eacute;tiers de l&rsquo;eau&nbsp;');
...
INSERT INTO `t_user` (`use_id`, `use_username`, `use_password`, `use_type`) VALUES
(1, 'uftam', 'uftam', '1');
...
--
-- Indexes for table `t_formation_msg`
--
ALTER TABLE `t_formation_msg`
  ADD PRIMARY KEY (`fms_id`),
  ADD KEY `fk3_formation` (`for_id`);
...
--
ALTER TABLE `t_diplome`
  MODIFY `dip_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
ALTER TABLE `t_formation`
  MODIFY `for_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `t_formation_msg`
--
ALTER TABLE `t_formation_msg`
  MODIFY `fms_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `t_la_vie`
--
ALTER TABLE `t_la_vie`
  MODIFY `tlv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `t_type_event`
  MODIFY `tte_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `t_formation_msg`
--
ALTER TABLE `t_formation_msg`
  ADD CONSTRAINT `fk3_formation` FOREIGN KEY (`for_id`) REFERENCES `t_formation` (`for_id`);
COMMIT;
