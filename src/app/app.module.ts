...
import { FileUploadComponent } from './internal-pages/file-upload/file-upload.component';
...
export const routes: Routes = [
  ...
  { path: 'uftam_partners', component: PartnersComponent, data: { animation: 'isRight' } },
  {
    ...
    children: [
      ...
      { path: 'uftam_certificate/:id/certificate', component: CertificateComponent },
    ]
  },
  ...
  { path: 'uftam_event/:id', component: UftamEventViewComponent },
  {
    ...
    children: [
      ...
      { path: 'candidatView', component: CondidatureViewComponent, },
