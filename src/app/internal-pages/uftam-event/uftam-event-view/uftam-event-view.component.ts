...
@Component({
  selector: 'app-uftam-event-view',
  templateUrl: './uftam-event-view.component.html',
  styleUrls: ['./uftam-event-view.component.css']
})
export class UftamEventViewComponent implements OnInit {
