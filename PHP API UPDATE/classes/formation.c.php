...
class Formation extends database
{
    ...
    public function getAllDocuments()
    {
        $query = $this->connect()->prepare(
            "SELECT ttf_lib, for_id, for_lib, for_document
    ...
    {
        $query = $this->connect()->prepare(
            "SELECT f.*, dip_logo, ttf_lib, type
    ...
    public function displayFormationDetails_Certificate($id)
    {
        $query = $this->connect()->prepare(
            "SELECT f.*, dip_logo, ttf_lib, type
            FROM  t_type_formation JOIN t_formation f USING(ttf_id)
        ...
        $query->execute([(int) $id, 'Certificats', (int) $id]);
        return $query;
    }
